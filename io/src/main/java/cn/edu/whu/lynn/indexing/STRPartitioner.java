...
public class STRPartitioner extends SpatialPartitioner {
  ...
  @Override
  public void setup(ButterflyOptions conf, boolean disjoint) {
  ...
  public String toString() {
    return "STRPartitioner{"+ numPartitions()+","+(disjoint? "disjoint" : "non-disjoint") +'}';
  }
}
