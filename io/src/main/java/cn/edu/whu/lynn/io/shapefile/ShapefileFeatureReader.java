...
import cn.edu.whu.lynn.io.SpatialReaderMetadata;
...
import org.apache.spark.cvas.CRSServer;
...
public class ShapefileFeatureReader extends FeatureReader {
  ...
  protected ButterflyOptions conf;
  ...
  public void initialize(Path shapefilePath, ButterflyOptions conf) throws IOException {
    this.conf = conf;
