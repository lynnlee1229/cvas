...
public class GeoJSONFeatureReader extends FeatureReader {
  ...
  @Override
  public void initialize(InputSplit genericSplit, ButterflyOptions conf) throws IOException {
   ...
   * @throws IOException if an error happens while opening the input file
   */
  protected void initialize(Path file, long start, long length, ButterflyOptions conf) throws IOException {
    this.start = start;
    this.eos = length == 0;
