 ...
 */
class SpatialGeneratorBuilder(sparkContext: SparkContext, opts: ButterflyOptions = new ButterflyOptions()) {
   ...
   * @return this object
   */
  def config(opts: ButterflyOptions): SpatialGeneratorBuilder = {
