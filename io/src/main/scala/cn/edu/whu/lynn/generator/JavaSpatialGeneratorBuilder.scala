 ...
 */
package cn.edu.whu.lynn.generator

import cn.edu.whu.lynn.common.ButterflyOptions
import cn.edu.whu.lynn.core.SpatialDataTypes.JavaSpatialRDD
 ...
 */
class JavaSpatialGeneratorBuilder(sparkContext: SparkContext, opts: ButterflyOptions = new ButterflyOptions()) {
  ...
  def config(opts: ButterflyOptions): JavaSpatialGeneratorBuilder = {
