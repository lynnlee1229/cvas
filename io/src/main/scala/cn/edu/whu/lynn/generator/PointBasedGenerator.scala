...
import cn.edu.whu.lynn.geolite.{EnvelopeND, EnvelopeNDLite, GeometryType, PointND}
...
//        point
        // TODO retrun point not pointND
        geometryFactory.createPoint(point.getCoordinate)
    }
  }
