...
public class SpatialReaderTest extends JavaSpatialSparkTest {
  ...
  public void testReadTwoFilesWithDifferentFormats() {
    ...
    ButterflyOptions opts = new ButterflyOptions(false).set("iformat[0]", "envelope")
        .set("iformat[1]", "point");
    opts.set(CSVFeatureReader.FieldSeparator, ",");

    ButterflyOptions opts0 = opts.retainIndex(0);
    ...
    ButterflyOptions opts1 = opts.retainIndex(1);
