...
public class CatTest extends JavaSpatialSparkTest {
  ...
  public void testConvertToRTree() {
    ...
    ButterflyOptions opts = new ButterflyOptions(false).set("iformat","point").set("oformat", "rtree");
    ...
    opts = new ButterflyOptions(false).set("iformat", "rtree").set("oformat", "point");
    opts.set(CSVFeatureReader.FieldSeparator, ",");
