...
import cn.edu.whu.lynn.geolite.{Feature, PointND}
import cn.edu.whu.lynn.io.GeoJSONFeatureWriter
...
class GeoJSONSourceTest extends FunSuite with CvasSpatialTest {
