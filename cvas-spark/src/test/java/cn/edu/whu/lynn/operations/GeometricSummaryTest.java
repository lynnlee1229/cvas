...
import cn.edu.whu.lynn.synopses.SummaryAccumulator;
...
public class GeometricSummaryTest extends JavaSparkTest {
  ...
  public void testComputeOutputSizeWithDifferentOutputFormat() {
    ...
    opts = new ButterflyOptions(false).set("iformat", "envelope").set("separator", ",");
  ...
  public void testAutodetect() {
    ...
    try {
      Summary s = (Summary) GeometricSummary.run(new ButterflyOptions(), new String[] {input.getPath()}, null, sparkContext());
