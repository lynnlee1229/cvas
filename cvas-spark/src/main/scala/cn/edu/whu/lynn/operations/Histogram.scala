...
object Histogram extends CLIOperation with Logging {
  ...
  @varargs def computePointWriteSizeHistogram(features: SpatialRDD, mbb: EnvelopeNDLite, opts: ButterflyOptions, numBuckets: Int*):
    UniformHistogram = {
  ...
  @varargs def computePointWriteSizeHistogram(features: JavaSpatialRDD, mbb: EnvelopeNDLite, opts: ButterflyOptions, numBuckets: Int*):
      UniformHistogram =
