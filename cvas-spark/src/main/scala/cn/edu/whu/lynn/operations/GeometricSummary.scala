...
import cn.edu.whu.lynn.io.ReadWriteMixin.ReadWriteMixinFunctions
import cn.edu.whu.lynn.io.{FeatureWriter, SpatialFileRDD, SpatialOutputFormat, SpatialWriter}
import cn.edu.whu.lynn.synopses.{BoxCounting, Summary, SummaryAccumulator}
...
object GeometricSummary extends CLIOperation with Logging {
  ...
  /** Java shortcut */
  def computeForFeaturesWithOutputSize(features: JavaSpatialRDD, opts: ButterflyOptions) : Summary =
  ...
  /**
    ...
    * @return
    */
  def computeForFeaturesWithOutputSize(features : SpatialRDD, opts : ButterflyOptions) : Summary =
    Summary.computeForFeatures(features, new FeatureWriterSize(opts))
  ...
  /**
    ...
    */
  def createSummaryAccumulatorWithWriteSize(sc: SparkContext, opts : ButterflyOptions) : SummaryAccumulator =
