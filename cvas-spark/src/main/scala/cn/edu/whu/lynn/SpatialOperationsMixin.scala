...
import cn.edu.whu.lynn.core.{CGOperationsMixin, SJAlgorithm, SJPredicate, SpatialPartitioner}
...
trait SpatialOperationsMixin extends CGOperationsMixin {
  ...
  implicit class RDDSpatialFunctions2(rdd: SpatialRDD) {
     ...
     */
    def spatialJoin(rdd2: SpatialRDD, joinPredicate: SJPredicate = SJPredicate.Intersects,
                    method: SJAlgorithm = null, mbrCount: LongAccumulator = null,
  ...
  implicit class RDDPartitionedSpatialFunctions2(partitionedRDD: PartitionedSpatialRDD) {
     ...
     * @return
     */
    def spatialJoin(partitionedRDD2: PartitionedSpatialRDD, joinPredicate: SJPredicate = SJPredicate.Intersects,
