...
import cn.edu.whu.lynn.common.CLIOperation;
...
public class OperationUtilTestOperations {
  ...
  public static class TestBaseClass implements JCLIOperation {
    ...
    @Override
    public Object run(ButterflyOptions opts, String[] inputs, String[] outputs, JavaSparkContext sc) throws IOException {
      return null;
    }
  }
  ...
  public static class TestSubClass implements CLIOperation {
    ...
    @Override
    public Object run(ButterflyOptions opts, String[] inputs, String[] outputs, SparkContext sc) throws IOException {
      return null;
    }
  }
