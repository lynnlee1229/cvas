...
public abstract class Plotter implements Serializable {
   ...
   */
  public static Plotter createAndConfigurePlotter(ButterflyOptions opts) {
    // 1- Try a class name
   ...
   */
  public static Plotter getConfiguredPlotter(String plotterShortName, ButterflyOptions conf) {
    return getConfiguredPlotter(getPlotterClass(plotterShortName), conf);
  }

  public static Plotter getConfiguredPlotter(Class<? extends Plotter> plotterClass, ButterflyOptions conf) {
    try {
  ...
  public static Map<String, Class<? extends Plotter>> loadPlotters() {
    ...
    List<String> partitionerClasses = OperationHelper.readConfigurationXML("cvas.xml").get("Plotters");
