...
public class GeometricPlotterTest extends TestCase {
  ...
  public void testPlotMultiPolygon() throws IOException {
    ...
    plotter.setup(opts);
    cn.edu.whu.lynn.davinci.Canvas canvas = plotter.createCanvas(100, 100, mbr, 0);
  ...
  public void testPlotPolygonWithoutHoles() throws IOException {
    ...
    ButterflyOptions opts = new ButterflyOptions().set("fill", "black");
    plotter.setup(opts);
    cn.edu.whu.lynn.davinci.Canvas canvas = plotter.createCanvas(100, 100, mbr, 0);
  ...
  public void testLinestring() throws IOException {
    GeometricPlotter plotter = new GeometricPlotter();
    Envelope mbr = new Envelope( 0.0, 1.0, 0.0, 1.0);
    ButterflyOptions opts = new ButterflyOptions().set(GeometricPlotter.Antialiasing, false);
    plotter.setup(opts);
    cn.edu.whu.lynn.davinci.Canvas canvas = plotter.createCanvas(100, 100, mbr, 0);
  ...
  public void testLinestring2() throws ParseException, IOException {
    ...
    int imageSize = 100;
    plotter.setup(opts);
    cn.edu.whu.lynn.davinci.Canvas canvas = plotter.createCanvas(imageSize, imageSize, mbr, 0);
    plotter.plot(canvas, Feature.create(null, linestring));
  ...
  public void testMerge() throws IOException {
    ...
    ButterflyOptions opts = new ButterflyOptions().set(GeometricPlotter.Antialiasing, false);
    plotter.setup(opts);
    cn.edu.whu.lynn.davinci.Canvas canvas1 = plotter.createCanvas(100, 100, mbr, 0);
    MultiPolygon poly = factory.createMultiPolygon(new Polygon[] {createPolygonJTS(createCoordinateSequence(
        0.0, 0.0,
        0.0, 0.5,
        0.0001, 0.5,
    ...
    cn.edu.whu.lynn.davinci.Canvas canvas2 = plotter.createCanvas(100, 100, mbr, 0);
  ...
  public void testPlotPointsAsPixels() throws IOException {
    ...
    ButterflyOptions opts = new ButterflyOptions().set(GeometricPlotter.Antialiasing, false).set("pointsize", 5);
    plotter.setup(opts);

    Envelope mbr = new Envelope( 0.0, 256.0, 0.0, 256.0);
    cn.edu.whu.lynn.davinci.Canvas canvas = plotter.createCanvas(256, 256, mbr, 0);
  ...
  public void testPlotPointsAsPixelsWithPointSizeZero() throws IOException {
    GeometricPlotter plotter = new GeometricPlotter();
    // Set up a plotter with five-pixel point size
    ButterflyOptions opts = new ButterflyOptions().set(GeometricPlotter.Antialiasing, false).set(GeometricPlotter.PointSize, 0);
    plotter.setup(opts);
  ...
  public void testPlotPointsAsCircles() throws IOException {
    GeometricPlotter plotter = new GeometricPlotter();
    // Set up a plotter with five-pixel point size
    ButterflyOptions opts = new ButterflyOptions().set(GeometricPlotter.PointSize, 5);
    plotter.setup(opts);
  ...
  public void testPlotPointsAsCirclesWithMerge() throws IOException {
    ...
    Envelope mbr = new Envelope( 0.0, 256.0, 0.0, 256.0);
    cn.edu.whu.lynn.davinci.Canvas canvas1 = plotter.createCanvas(256, 256, mbr, 0);
    ...
    cn.edu.whu.lynn.davinci.Canvas canvas2 = plotter.createCanvas(256, 256, mbr, 0);
